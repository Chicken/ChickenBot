...
exports.execute = async (client, message, args) => {
    ...
    embed
        ...
        .addField("Id", info.id)
        .addField("Created", client.formatDate(info.createdAt) + `\n(${client.formatDuration(Date.now() - info.createdAt)} ago)`, true)
        .addField("Joined", client.formatDate(member.joinedAt) + `\n(${client.formatDuration(Date.now() - member.joinedAt)} ago)`, true)
